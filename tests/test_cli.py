...
from kcal.cli import _render_csv, resolve_days
...
def test_render_csv_header_and_row():
    ...
    assert rows[0] == (
        "date,activity_active_calories,activity_total_calories,steps,"
        "non_activity_steps,estimated_step_calories,active_calories,"
        "passive_calories"
    )
